...
\textbf{Task (10 min):} Draw samples of different sizes of 10, 50, and 200, and compute sample mean and variance using DAX functions \texttt{SAMPLE,AVERAGEX,VARX.S}.
